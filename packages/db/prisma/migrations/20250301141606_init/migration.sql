...
-- CreateEnum
CREATE TYPE "EthnicityEnum" AS ENUM ('Asian', 'Black', 'Hispanic', 'Indian', 'Middle_Eastern', 'NativeAmerican', 'PacificIslander', 'White', 'Other');

-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Brown', 'Blue', 'Green', 'Hazel', 'Gray', 'Other');
